<?php
    ...
    function addMechanic($conn){
        ...
        $query_to_add_driver = "INSERT INTO `driver`(`fullname`, `contactnumber`, `address`, `service_center`) VALUES ('$mechanic_name','$mechanic_number','$mechanic_address','$serviceCenter')";

        mysqli_query($conn, $query_to_add_driver);
